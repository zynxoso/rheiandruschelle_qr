...
const caseStudies = {
  ...
  scholarship: {
    ...
    phases: [
      ...
      ['03', 'Build', 'Developed the application with Laravel, Livewire, Alpine.js, Tailwind CSS, and MySQL, deployed to Hostinger.', 'Working TALL stack portal on Hostinger'],
    ...
    heroImageCaption: 'CLSU ERDT PRISM public graduate scholarship portal built with TALL stack on Hostinger',
    ...
    finalImpact: 'The Scholarship Portal connects master’s and PhD applications with CLSU ABE review in one searchable digital workflow built on the TALL stack and hosted on Hostinger.',
